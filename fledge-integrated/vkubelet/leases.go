...
func NewController(clock clock.Clock, client clientset.Interface, holderIdentity string, leaseDurationSeconds int32, onRepeatedHeartbeatFailure func()) *LeaseController {
...
// false otherwise.
func (c *LeaseController) BackoffEnsureLease() (*coordv1beta1.Lease, bool) {
	var (
...
func (c *LeaseController) ensureLease() (*coordv1beta1.Lease, bool, error) {
...
func (c *LeaseController) RetryUpdateLease(base *coordv1beta1.Lease) {
...
func (c *LeaseController) newLease(base *coordv1beta1.Lease) *coordv1beta1.Lease {
