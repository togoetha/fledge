...
devname=$(hostname)
ctr images pull docker.io/togoetha/vkubelet-service-amd64:latest --snapshotter=native
...
docker.io/togoetha/vkubelet-service-amd64:latest vkubelet-service /usr/bin/vkubelet-service "/config/vkubeconfig.json" 
