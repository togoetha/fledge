...
func UpdatePodStatus(podStatus v1.PodCondition, containerStatuses []v1.ContainerStatus, pod *v1.Pod, noErrors bool, allContainersRunning bool, allContainersDone bool) {
