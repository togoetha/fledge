...
clPeak::clPeak(): forcePlatform(false), forceDevice(false),
  ...
  try
  {
    ...
    for(size_t p=0; p < platforms.size(); p++)
    {
      ...
      for(size_t d=0; d < devices.size(); d++)
      {
        ...
        log->print(devType + "##" + platformName + "##" + devInfo.deviceName + "##" + devInfo.clVersion);
        ...
        log->print(TAB TAB "OpenCL version  : ");
        log->print(devInfo.clVersion);      log->print(NEWLINE);
